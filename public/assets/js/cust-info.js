...
for (let i = today.getDate(); i <= today.getDate() + 60; i++) {
...
// for (let i = 0; i < 60; i++) { // Loop untuk 60 hari
//     const date = new Date(today); // Buat objek tanggal baru dari hari ini
//     date.setDate(today.getDate() + i); // Tambahkan 'i' hari ke tanggal tersebut

//     const dayOfMonth = date.getDate();
//     const month = date.toLocaleString('default', {
//         month: 'short' // 'Jan', 'Feb', dst.
//     });
//     const year = date.getFullYear(); // Dapatkan tahun juga

//     const realDate = date.toISOString().split('T')[0]; // Format YYYY-MM-DD untuk value input
...
//                 <p class="font-semibold text-nowrap">${dayOfMonth} ${month} ${year}</p> {{-- Tampilkan tanggal, bulan, tahun --}}
//                 <input type="radio" name="start_date" class="absolute top-1/2 left-1/2 -z-10 opacity-0" value="${realDate}">
//             </label>
//         </div>`;
// }
