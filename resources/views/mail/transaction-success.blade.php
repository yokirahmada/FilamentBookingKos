...
<head>
    ...
    <title>Konfirmasi Pembayaran Anda Berhasil!</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
    <style type="text/css">
        /* Gaya dasar untuk kompatibilitas klien email */
        body {
            font-family: 'Poppins', Arial, sans-serif; /* <<< TAMBAHKAN 'Poppins' DI SINI */
            margin: 0;
            padding: 0;
        ...
        /* Header email */
        .header {
            background-color: #D2EDE4; /* Ngekos-green muda */
            padding: 30px;
            text-align: center;
            color: #333333;
        }
...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4; color: #333333;">
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                    <td class="content" style="padding: 30px;">
                        <p style="margin-bottom: 15px; line-height: 1.6; font-size: 16px;">Halo <strong style="color: #333333;">{{ $transaction->user->name }}</strong>,</p>
                        <p style="margin-bottom: 15px; line-height: 1.6; font-size: 16px;">Kami ingin mengkonfirmasi bahwa pembayaran Anda untuk order ID <strong style="color: #333333;">{{ $transaction->code }}</strong> telah berhasil kami terima. Terima kasih telah menggunakan layanan kami!</p>
                        ...
                        <div class="transaction-summary" style="background-color: #f9f9f9; border: 1px solid #eeeeee; border-radius: 8px; padding: 20px; margin-top: 25px;">
                            <h2 style="margin-top: 0; color: #3A9B26; font-size: 20px; margin-bottom: 15px;">Detail Pembayaran</h2>
                        ...
                        <div class="transaction-summary" style="background-color: #f9f9f9; border: 1px solid #eeeeee; border-radius: 8px; padding: 20px; margin-top: 25px;">
                            <h2 style="margin-top: 0; color: #3A9B26; font-size: 20px; margin-bottom: 15px;">Detail Pemesanan Kos</h2>
                        ...
                        <p style="margin-bottom: 15px; line-height: 1.6; font-size: 16px;">Anda bisa datang ke lokasi kos mulai tanggal yang tertera. Jika ada pertanyaan lebih lanjut, jangan ragu untuk menghubungi tim dukungan kami.</p>
                        <p style="margin-bottom: 15px; line-height: 1.6; font-size: 16px;">Salam hangat,</p>
